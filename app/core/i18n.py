...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "menu_retry": "Retry Episode",
        "menu_cancel": "Cancel Download",
        "menu_retry_group": "Retry Failed Episodes",
        "menu_remove_group": "Remove From Queue",
        "status_resolving": "Loading episode list...",
        "status_queued": "Queued",
        "status_downloading": "Downloading",
        "status_retrying": "Retrying ({n}/{max})...",
        "status_failed": "Failed: {error}",
        "status_completed": "Completed",
        "status_group_failed": "{count} failed",
        "status_eps_done": "{done}/{total} eps",
        ...
        "lbl_save_folder": "Default Save Folder:",
    ...
    "km": {
        ...
        "col_status": "ស្ថានភាព",
        "btn_retry_failed": "ព្យាយាមម្តងទៀតដែលបរាជ័យ",
        "menu_retry": "ព្យាយាមភាគនេះម្តងទៀត",
        "menu_cancel": "បោះបង់ការទាញយក",
        "menu_retry_group": "ព្យាយាមភាគដែលបរាជ័យម្តងទៀត",
        "menu_remove_group": "ដកចេញពីបញ្ជី",
        "status_resolving": "កំពុងផ្ទុកបញ្ជីភាគ...",
        "status_queued": "កំពុងរង់ចាំ",
        "status_downloading": "កំពុងទាញយក",
        "status_retrying": "កំពុងព្យាយាមម្តងទៀត ({n}/{max})...",
        "status_failed": "បរាជ័យ: {error}",
        "status_completed": "រួចរាល់",
        "status_group_failed": "បរាជ័យ {count}",
        "status_eps_done": "{done}/{total} ភាគ",
        ...
        "lbl_save_folder": "ថតរក្សាទុកលំនាំដើម:",
